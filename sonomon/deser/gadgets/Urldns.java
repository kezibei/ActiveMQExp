...
public class Urldns {
	...
	static String[] jndidefaultclass = {
			...
			//"com.sun.glass.utils.NativeLibLoader",//jdk就有省略
    ...
    public static byte[] getjavaSerializedData(String clazzs, String dns) throws Exception {
    	dnslog = dns;
  		...
  		return Deserialize.objectToBytes(list);
    }
    ...
    public static  void setlist(String clazzName) throws Exception{
		...
		case "ROME":
			...
			break;
		case "Fastjson":
			//fastjson<=1248存在一个链,全版本的链需要用hashMap绕过checkAutoType
			...
			break;
		case "Jackson":
			//jackson-databind>=2.10.0存在一个链,此链不是稳定触发,需要springAOP协助
